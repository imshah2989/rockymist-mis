...
DB_PATH = r"G:\My Drive\RockyMist Financial MIS\RockyMist_System.db"
BACKUP_DIR = r"G:\My Drive\RockyMist Financial MIS\Backups"
...
active_unit = st.sidebar.selectbox("Unit", ["Penthouse Dream", "Family Suite", "Executive Suite"])
